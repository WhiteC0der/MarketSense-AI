      ...
      <div className="bg-zinc-900/60 backdrop-blur-md border-b border-zinc-800 p-4 space-y-3">
        ...
        <div className="relative h-52 bg-zinc-900/40 rounded-lg border border-zinc-800/50 overflow-hidden">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart key={`${ticker}-${chartToDisplay.length}`} data={chartToDisplay} margin={{ top: 5, right: 30, left: 50, bottom: 5 }}>
              <defs>
              ...
              <YAxis domain={['dataMin - 2', 'dataMax + 2']} axisLine={false} tickLine={false} tick={{ fill: '#71717a', fontSize: 10 }} tickFormatter={(v) => `$${v}`} />
